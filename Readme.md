...
```bash
nasm -f elf32 230101016_seta11.asm -o program.o
...
```bash
gcc 230101016_twopass.c -o twopass
./twopass
```
...
```bash
gcc 230101016_onepass.c -o onepass
./onepass
```
